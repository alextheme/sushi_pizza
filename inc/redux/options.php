...
$args = array(
    ...
    'menu_title'                => esc_html__( 'Theme Options', 'sushi_pizza' ),

    // The text to appear on the page title.
    'page_title'                => esc_html__( 'Theme Options', 'sushi_pizza' ),
...
$args['share_icons'][] = array(
    'url'   => 'https://alextheme.github.io/',
    'title' => 'developer Oleksandr Borymskyi took part in the development of this topic',
    'icon'  => 'el el-github',
);
...
$help_tabs = array(
    array(
        'id'      => 'redux-help-tab-1',
        'title'   => esc_html__( 'Theme Information 1', 'sushi_pizza' ),
        'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'sushi_pizza' ) . '</p>',
    ),
    array(
        'id'      => 'redux-help-tab-2',
        'title'   => esc_html__( 'Theme Information 2', 'sushi_pizza' ),
        'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'sushi_pizza' ) . '</p>',
    ),
);
...
$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'sushi_pizza' ) . '</p>';
...
Redux::set_section( $opt_name, array(
        'title'            => esc_html__( 'Site Settings', 'sushi_pizza' ),
        'id'               => 'header',
...
// LOGO
Redux::set_section( $opt_name, array(
        'title'            => esc_html__( 'Logo', 'sushi_pizza' ),
        'id'               => 'header-logo',
        'subsection'       => true,
        'desc'             => esc_html__( '', 'sushi_pizza' ),
        'fields' => array(
            array(
                ...
                'type'     => 'media',
                'title'    => esc_html__( 'Logo', 'sushi_pizza' ),
                'desc'     => esc_html__( 'Upload logo site', 'sushi_pizza' ),
...
// SOCIALS
Redux::set_section( $opt_name, array(
        'title'            => esc_html__( 'Socials', 'sushi_pizza' ),
        'id'               => 'header-socials',
        'subsection'       => true,
        'desc'             => esc_html__( '', 'sushi_pizza' ),
        'fields' => array(
...
//                'image'       => 'new social link',
//                'thumb'       => 'new social link',
                'placeholder' => array(
...
//    $opt_name,
//    array(
//        'title'            => esc_html__( 'Basic fields & Editors', 'sushi_pizza' ),
//        'id'               => 'editor',
...
//    $opt_name,
//    array(
//        'title' => esc_html__( 'Color Selection', 'sushi_pizza' ),
//        'id'    => 'color',
//        'icon'  => 'el el-brush',
//    )
//);
...
//    $opt_name,
//    array(
//        'title' => esc_html__( 'Design Fields', 'sushi_pizza' ),
//        'id'    => 'design',
//        'icon'  => 'el el-wrench',
//    )
//);
...
//    $opt_name,
//    array(
//        'title' => esc_html__( 'Media Uploads', 'sushi_pizza' ),
//        'id'    => 'media',
//        'icon'  => 'el el-picture',
//    )
//);
...
//    $opt_name,
//    array(
//        'title' => esc_html__( 'Presentation Fields', 'sushi_pizza' ),
//        'id'    => 'presentation',
//        'icon'  => 'el el-screen',
//    )
//);
...
//    $opt_name,
//    array(
//        'title' => esc_html__( 'Switch / Button Set', 'sushi_pizza' ),
//        'id'    => 'switch_buttonset',
//        'icon'  => 'el el-cogs',
//    )
//);
...
//    $opt_name,
//    array(
//        'title' => esc_html__( 'Select Fields', 'sushi_pizza' ),
//        'id'    => 'select',
//        'icon'  => 'el el-list-alt',
//    )
//);
...
//    $opt_name,
//    array(
//        'title' => esc_html__( 'Slider / Spinner', 'sushi_pizza' ),
//        'id'    => 'slider_spinner',
...
//    $opt_name,
//    array(
//        'title' => esc_html__( 'Additional Types', 'sushi_pizza' ),
//        'id'    => 'additional',
//        'icon'  => 'el el-magic',
//    )
//);
...
//    $opt_name,
//    array(
//        'title' => esc_html__( 'Advanced Features', 'sushi_pizza' ),
...
//    $opt_name,
//    array(
//        'title' => esc_html__( 'Disabling', 'sushi_pizza' ),
//        'icon'  => 'el el-lock',
//    )
//);
//
...
//    $opt_name,
//    array(
//        'title' => esc_html__( 'Redux Extensions', 'sushi_pizza' ),
//        'id'    => 'redux-extensions',
//        'icon'  => 'el el-redux',
//        'class' => 'pro_highlight',
//        'desc'  => esc_html__( 'For full documentation on this field, visit: ', 'sushi_pizza' ) . '<a href="https://devs.redux.io/core-extensions/" target="_blank">https://devs.redux.io/core-extensions/</a>',
//    )
//);
//
...
//    $section = array(
//        'icon'   => 'el el-list-alt',
//        'title'  => esc_html__( 'Documentation', 'sushi_pizza' ),
//        'fields' => array(
//            array(
...
//    array(
//        'icon'            => 'el el-list-alt',
//        'title'           => esc_html__( 'Customizer Only', 'sushi_pizza' ),
//        'desc'            => '<p class="description">' . esc_html__( 'This Section should be visible only in Customizer', 'sushi_pizza' ) . '</p>',
//        'customizer_only' => true,
//        'fields'          => array(
//            array(
//                'id'              => 'opt-customizer-only',
//                'type'            => 'select',
//                'title'           => esc_html__( 'Customizer Only Option', 'sushi_pizza' ),
//                'subtitle'        => esc_html__( 'The subtitle is NOT visible in customizer', 'sushi_pizza' ),
//                'desc'            => esc_html__( 'The field desc is NOT visible in customizer.', 'sushi_pizza' ),
//                'customizer_only' => true,
//                'options'         => array(
//                    '1' => esc_html__( 'Opt 1', 'sushi_pizza' ),
//                    '2' => esc_html__( 'Opt 2', 'sushi_pizza' ),
//                    '3' => esc_html__( 'Opt 3', 'sushi_pizza' ),
//                ),
//                'default'         => '2',
//            ),
//        ),
...
if ( ! function_exists( 'dynamic_section' ) ) {
    ...
    function dynamic_section( array $sections ): array {
        $sections[] = array(
            'title'  => esc_html__( 'Section via hook', 'sushi_pizza' ),
            'desc'   => '<p class="description">' . esc_html__( 'This is a section created by adding a filter to the sections array. Can be used by child themes to add/remove sections from the options.', 'sushi_pizza' ) . '</p>',
...
if ( ! function_exists( 'change_defaults' ) ) {
    ...
    function change_defaults( array $defaults ): array {
        $defaults['str_replace'] = esc_html__( 'Testing filter hook!', 'sushi_pizza' );
